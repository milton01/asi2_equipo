...
--
-- Host: 127.0.0.1    Database: altuve_1
-- ------------------------------------------------------
...
INSERT INTO `almacen` (`id`, `descripcion`) VALUES (1,'listo para la venta'),(2,'En ruta'),(3,'avería y vencidos');
...
INSERT INTO `carga` (`id`, `fecha`, `hora`, `descripcion`, `transporte_placa`, `empleado_id`, `ruta_id`) VALUES (1,'2014-06-08','08:55:00','Carga va hacia Deposito','C-4568',1,9011),(2,'2014-06-08','08:55:00','Carga va hacia Perla','C-4568',1,9011),(3,'2014-07-08','08:55:00','Carga va hacia Mizata','C-4768',2,9011),(4,'2014-08-08','08:55:00','Carga va hacia Terminal','C-4868',3,9011);
...
INSERT INTO `categoriap` (`id`, `descripcion`) VALUES (1,'Gaseosa'),(2,'Cerveza'),(3,'Agua'),(4,'Jugos');
...
INSERT INTO `cliente` (`cliente_id`, `nit`, `dui`, `registro`, `giro`, `nombre_j`, `nombre_c`, `contacto`, `telefono_1`, `telefono_2`, `celular`, `fax`, `correo`, `tipo`, `categoria`, `direccion`, `municipio`, `departamento`, `statu_cred`, `ruta_id`, `status_id`, `usuario_id`) VALUES (1,'01010509921014','046897914',1035,'Venta de bebidas','Ventas libres S.A de C.V.','Venta de bebidas','Julieta Moffan',75526542,NULL,NULL,NULL,'ventas@gmail.com','JU','C','Cantón el Progreso, Lote #23 Frente a escuela ','Mizata','La Libertad',0,9011,2,2),(2,'01010509921015','046897958',105,'Venta de carnes y embutidos','Pablo Hernandez','Don Pablo','Pablo Hernandez',73871107,0,0,0,'pablito@gmail.com','na','c','Av. A Urbanización Plaza las Colinas.','Ciudad Arce','La Libertad',0,9011,1,1);
...
INSERT INTO `compra` (`id`, `compra_fecha`, `proveedor_id`) VALUES (1,'2014-06-05',1),(2,'2014-06-05',1),(3,'2014-07-05',2),(4,'2014-07-05',3),(5,'2014-08-05',1);
...
INSERT INTO `detalle_carga_producto` (`id`, `cantidad`, `codigoprod`, `carga_id`) VALUES (1,50,2020,1),(2,50,2020,1),(3,50,2020,1),(4,50,2020,1);
...
INSERT INTO `detalle_compra` (`id`, `cantidad`, `fecha`, `compra_id`, `producto_codigo`) VALUES (1,100,'2014-05-06 06:00:00',1,2020),(2,100,'2014-05-06 06:00:00',1,2020),(3,80,'2014-05-07 06:00:00',1,2021),(4,90,'2014-05-08 06:00:00',1,2025);
...
INSERT INTO `detalle_pedido` (`id`, `cantidad`, `codigoprod`, `pedido_id`) VALUES (1,10,2020,1),(2,10,2020,1),(3,2,2020,3),(4,3,2025,3),(5,14,2025,4),(6,3,2025,5),(7,7,2025,6),(8,12,2025,7),(9,12,2025,8),(10,8,2020,8),(11,17,2020,2),(12,12,2020,2),(13,1,2021,2);
...
INSERT INTO `documento` (`id`, `nombre`) VALUES (1,'Factura'),(2,'Comprobante de crédito fiscal'),(3,'Quedan');
...
INSERT INTO `empleado` (`id`, `dui`, `nombres`, `apellidos`, `cargo`, `fecha_ingreso`, `telefono`, `direccion`, `rutaid`, `status_id`, `usuario_id`) VALUES (1,4689795,'Miguel Angel','Flores Perez','vendedor','2009-01-01',78985245,'Urbanizacion Las Flores, Sonsonate.',9011,1,1),(3,4689795,'Carlos Angel','Sanchez Perez','vendedor','2009-01-01',78985245,'Urbanizacion Las Flores, Sonsonate.',9011,1,2),(4,4689798,'JUlio Angel','Juarez Perez','vendedor','2009-01-01',78985245,'Urbanizacion Las Flores, Sonsonate.',9011,1,3);
...
INSERT INTO `estatus` (`id`, `nombre`, `descripcion`) VALUES (1,'P','Pendiente'),(2,'R','Rechazado'),(3,'ND','No Despachado'),(4,'D','Despachado'),(5,'A','Activo'),(6,'V','Vendido'),(7,'DV','Devolucion');
...
INSERT INTO `gastos_ruta` (`id`, `valor`, `descripcion`) VALUES (1,38.25,'Combustible'),(2,20.3,'Cambio de llantas'),(3,87.65,'Cambio de aceite motor');
...
INSERT INTO `inventario` (`id`, `codigoprod`, `cantidad`, `fecha_mov`, `tipo_mov`, `movimientoid`, `almacenid`, `no_transaccion`) VALUES (1,2020,'300','2014-11-21','II',1,1,1),(2,2020,'10','2014-11-24','2',2,1,1),(3,2020,'-10','2014-11-24','6',6,2,1),(4,2020,'10','2014-11-24','2',2,1,1),(5,2020,'-10','2014-11-24','6',6,2,1);
...
INSERT INTO `marca` (`id`, `nombre`) VALUES (1,'Coca Cola'),(2,'Fanta'),(3,'Uva'),(4,'Fresa'),(5,'Sprite'),(6,'Crema Soda'),(7,'Pilsener'),(8,'Golden'),(9,'Regia'),(10,'Mandarina'),(11,'Naranja'),(12,'Oasis');
...
INSERT INTO `pedido` (`id`, `fecha_v`, `fecha_p`, `forma_pago`, `docto`, `motivo_r`, `status_id`, `cliente_id`, `docto_id`) VALUES (3,'2014-11-11 00:00:00','2014-11-04 00:00:00','Contado',901232,NULL,4,1,1),(4,'2014-11-29 06:00:00','2014-11-29 06:00:00','contado',12345,NULL,1,1,1),(5,'2014-11-04 00:00:00','2014-11-05 00:00:00','contado',12,'',3,2,2),(6,'2014-11-10 00:00:00','2014-11-11 00:00:00','contado',13,'',1,2,2),(7,'2014-11-10 00:00:00','2014-11-11 00:00:00','contado',13,NULL,1,10,3),(8,'2014-11-11 00:00:00','2014-11-11 00:00:00','contado',14,NULL,3,10,2),(9,'2014-11-17 00:00:00','2014-11-18 00:00:00','contado',14,NULL,1,2,3),(10,'2014-11-17 00:00:00','2014-11-18 00:00:00','contado',14,NULL,2,2,3);
...
INSERT INTO `producto` (`codigo`, `preciov`, `precioc`, `marcaid`, `categoriaid`, `fecha`, `descripcion`, `capacidad`) VALUES (1010,4,2.5,12,3,'2014-12-01 05:04:22','24unidades',0.45),(2020,5.7,5,1,1,'2015-01-01 06:00:00','6.5 oz VR 24 U',0),(2022,6.5,5,1,1,'2014-12-01 05:02:47','16OnzVR',0.25),(2025,7.5,6,7,2,'2014-12-01 05:02:47','Lite VR12Oz',0.3);
...
INSERT INTO `proveedor` (`id`, `nit`, `giro`, `registro`, `nombre`, `contacto`, `telefono`, `correo`, `direccion`) VALUES (1,'01010509921018','Venta de bebidas','10325','Industrias La Constancia','Juan Jose Hoffman',78956412,'jofman@hotmail.com','Residenciar Altos de Santa Teresa, calle el pedregal, bloc 9 #23');
...
) ENGINE=InnoDB AUTO_INCREMENT=9014 DEFAULT CHARSET=utf8 COMMENT='	';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ruta` (`id`, `nombre`) VALUES (9011,'Mizata'),(9012,'Terminal'),(9013,'Moto');
...
INSERT INTO `tipo_movimiento` (`id`, `codigo`, `descripcion`) VALUES (1,'I','Inventario Inicial'),(2,'V','Venta'),(3,'C','Compra'),(4,'A','Ajuste'),(5,'D','Devolucion'),(6,'R','Ruta');
...
INSERT INTO `usuario` (`id`, `nombre`, `password`, `tipo`) VALUES (1,'admin','25d55ad283aa400af464c76d713c07ad','administrador'),(2,'cliente','25d55ad283aa400af464c76d713c07ad','cliente'),(3,'telventa','25d55ad283aa400af464c76d713c07ad','televendedor'),(4,'bodeguero','25d55ad283aa400af464c76d713c07ad','bodeguero');
...
INSERT INTO `venta` (`id`, `fecha`, `no_doc`, `empleado_id`, `ruta_id`) VALUES (1,'2014-05-08','901232',1,9011),(2,'2014-05-08','901236',1,9011),(3,'2014-06-08','901235',2,9011),(4,'2014-07-08','901237',3,9012);
...
/*!50001 DROP TABLE IF EXISTS `pedido_realizado`*/;
/*!50001 DROP VIEW IF EXISTS `pedido_realizado`*/;
...
/*!50001 VIEW `pedido_realizado` AS select `pe`.`id` AS `id_venta`,date_format(`pe`.`fecha_v`,'%m-%d-%Y') AS `fecha_venta`,date_format(`pe`.`fecha_p`,'%m-%d-%Y') AS `fecha_pedido`,ucase(`pe`.`forma_pago`) AS `forma_pago`,`pe`.`docto` AS `documento`,`cl`.`giro` AS `giro`,`cl`.`nombre_j` AS `razon_social`,`cl`.`nombre_c` AS `nombre_comun`,`cl`.`contacto` AS `representante_empresa`,`cl`.`registro` AS `nrc`,`cl`.`nit` AS `nit`,`cl`.`dui` AS `dui`,`cl`.`correo` AS `correo`,`cl`.`tipo` AS `tipo`,`cl`.`categoria` AS `categoria`,`cl`.`municipio` AS `municipio`,`cl`.`departamento` AS `departamento`,`ru`.`nombre` AS `ruta_venta`,`es`.`nombre` AS `codigo_estado_venta`,`es`.`descripcion` AS `estado_venta` from ((((`pedido` `pe` join `cliente` `cl` on((`cl`.`cliente_id` = `pe`.`cliente_id`))) join `estatus` `es` on((`es`.`id` = `pe`.`status_id`))) join `documento` `do` on((`do`.`id` = `pe`.`docto_id`))) join `ruta` `ru` on((`ru`.`id` = `cl`.`ruta_id`))) */;
...
-- Dump completed on 2014-12-03 20:54:24
