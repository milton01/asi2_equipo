<div class="row">
	...
	<div class="row">
		<div class="the-box">
			<form role="form" id="productos-canasta" method="post" action="<?=base_url('productos/finalizado')?>">
				<select name="forma_pago" id="forma_pago">
					<option value="efectivo">Efectivo</option>
					<option value="credito">Credito</option>
				</select>
				<button type="submit" class="btn btn-success btn-block btn-lg"><i class="fa fa-sign-in"></i> Realizar Pedido</button>
				</form>
			</div>
		</div>