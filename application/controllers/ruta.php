...
class ruta extends CI_Controller {
    ...
    public function index() {        
        ...
        $this->template->write('title', 'Altuve | Rutas');
        $this->template->write('header', 'Rutas');
        $this->template->write_view('menu', 'menu/menu_admin');
        $this->template->write_view('content', 'ruta/listar', $data);
    ...
    public function ruta_pedidos($rt_id, $excede=null) {        
        ...
        //Se carga la vista con plantilla        
        $datajs['files'] = array('j1', 'j2', 'j3');
        $this->template->write('title', 'Altuve | Ruta | Pedidos');
        $this->template->write('header', 'Ruta | Pedidos');
        $this->template->write_view('menu', 'menu/menu_admin');
        $this->template->write_view('content', 'ruta/ruta_pedidos', $data);
        $this->template->write_view('scripts', 'master-scripts', $datajs);
        $this->template->render();
    }
